...
export const rgbToXyz = (expression : Rgb) : Point3d => pass_through = {x:expression.r, y:expression.g, z:expression.b};
...
export const rgbToHsl = (expression : Rgb) : Hsl => pass_through =
{
...
export const hslToRgb = (expression : Hsl) : Rgb => pass_through =
{
...
export const clipLightness = (expression : Hsl) : Hsl => pass_through =
{
    h: expression.h,
    s: expression.s,
...
export const clipRgb = (expression : Rgb) : Rgb => pass_through =
{
